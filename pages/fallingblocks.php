...
// LẤY ĐIỂM CAO NHẤT (GAME TYPE = FALLING)
$my_best_score = 0;
if($user_id) {
    ...
    <div class="game-wrapper">
        <div class="game-main-container">
            <div id="menuScreen" class="game-card">
                ...
                <div style="margin-bottom: 25px; display: inline-block; padding: 10px 25px; background: rgba(59, 130, 246, 0.15); border: 1px solid #3b82f6; border-radius: 50px; color: #60a5fa; font-weight: bold; font-family: monospace; font-size: 1.2rem;">
            ...
            <div id="playingScreen" class="game-card hidden fullscreen-game">
                ...
                <div id="gameArea" class="game-area">
                    <div class="hud-overlay">
                        <div class="hud-item score-container">
                            <i class="fas fa-trophy" style="color:#facc15; font-size:1.2rem;"></i>
                            <span id="scoreDisplay" style="margin-left:8px;">0</span>
                        </div>
                ...
                <div class="keyboard-hint" style="margin-top: 15px; color: #94a3b8; font-size: 0.95rem;">
                    <span><i class="fas fa-keyboard"></i> Type the falling words to destroy them!</span>
                </div>
        ...
        <div class="leaderboard-sidebar">
            <div class="lb-header"><i class="fas fa-crown" style="color: #facc15;"></i> Top Fallers</div>
            <div class="lb-list">
                <?php $_GET['game'] = 'falling'; include 'php/get_leaderboard.php'; ?>
            </div>
        </div>
    </div>
